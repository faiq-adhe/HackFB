    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCjuqVOmafRmwUDHhHe3o1Hg')
                time.sleep(2)
                menu()
